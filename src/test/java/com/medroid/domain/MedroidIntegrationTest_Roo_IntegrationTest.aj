...
import com.medroid.domain.MedroidIntegrationTest;
...
privileged aspect MedroidIntegrationTest_Roo_IntegrationTest {
    
    declare @type: MedroidIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: MedroidIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: MedroidIntegrationTest: @Transactional;
    
    @Autowired
    MedroidDataOnDemand MedroidIntegrationTest.dod;
    
    @Test
    public void MedroidIntegrationTest.testCountPatients() {
    ...
    @Test
    public void MedroidIntegrationTest.testFindPatient() {
    ...
    @Test
    public void MedroidIntegrationTest.testFindAllPatients() {
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", dod.getRandomPatient());
        long count = Patient.countPatients();
    ...
    @Test
    public void MedroidIntegrationTest.testFindPatientEntries() {
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", dod.getRandomPatient());
        long count = Patient.countPatients();
    ...
    @Test
    public void MedroidIntegrationTest.testFlush() {
        Patient obj = dod.getRandomPatient();
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Patient' failed to provide an identifier", id);
    ...
    @Test
    public void MedroidIntegrationTest.testMergeUpdate() {
        Patient obj = dod.getRandomPatient();
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Patient' failed to provide an identifier", id);
    ...
    @Test
    public void MedroidIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", dod.getRandomPatient());
    ...
    @Test
    public void MedroidIntegrationTest.testRemove() {
        Patient obj = dod.getRandomPatient();
        Assert.assertNotNull("Data on demand for 'Patient' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Patient' failed to provide an identifier", id);
